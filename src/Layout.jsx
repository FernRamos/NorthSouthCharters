                    ...
                    <div className="flex justify-between items-center h-20">
                        ...
                        <Link to={createPageUrl('Home')} className="flex items-center space-x-3">
                            ...
                            <div className="hidden sm:block">
                                <img 
                                    src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/696666cb8b0ce9b9ee0be45f/9d29013e8_logo-text.png" 
                                    alt="North South Charters" 
                                    className="h-10"
                                />
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            />
                            <p className="text-sm">
                                Nature Coast and Tampa Bay fishing charters. Family-friendly trips, inshore, nearshore, scalloping, and island hopping adventures.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-2 text-sm">
                                <a href="tel:+18139093901" className="flex items-center space-x-2 hover:opacity-80 transition">
                                    <Phone size={16} />
                                    <span>(813) 909-3901</span>
                                </a>
                                <a href="mailto:info@nscharters.com" className="flex items-center space-x-2 hover:opacity-80 transition">
                                    <Mail size={16} />
